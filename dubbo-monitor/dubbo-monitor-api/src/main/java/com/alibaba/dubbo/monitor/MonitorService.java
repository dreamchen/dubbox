...
public interface MonitorService {
     ...
     * 1.1 host,application,organization,owner,interface,group,version,method 记录监控来源主机，应用，机构，所有人，接口，方法信息。
     ...
     * 1.1 host,application,organization,owner,interface,group,version,method 查询主机，应用，机构，所有人，接口，方法的匹配条件，缺失的条件的表示全部，host用0.0.0.0表示全部。
